  ...
  return (
    <div>
      ...
      <div className="container">
        ...
        <p className="detail">
          At <span className="highlight">MYTRIPSAVER</span>, we take pride in
          our commitment to delivering exceptional service and value to our
          users. Our user-friendly interface allows you to effortlessly navigate
        ...
        <p className="detail">
          At <span className="highlight">MYTRIPSAVER</span>, our mission is to
        ...
        <p className="detail">
          ...
          <span className="highlight">MYTRIPSAVER</span> is also your go-to
