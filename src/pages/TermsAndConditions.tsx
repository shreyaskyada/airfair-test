  ...
  return (
    <div>
      ...
      >
        ...
        <>
          <h1 className='detail'>AGREEMENT TO OUR LEGAL TERMS</h1>
          <>
            <p className='detail'>
              We are MTS Travel Tech Pvt Ltd(
              <span className='highlight'>"Company," "we," "us," "our"</span>).
            </p>

            <p className='detail'>
              We operate , as well as any other related products and services
              that refer or link to these legal terms (the{' '}
              <span className='highlight'>"Legal Terms"</span>) (collectively,
              the <span className='highlight'>"Services"</span>).
            </p>

            <p className='detail'>
              You can contact us by email at info@tripsaverz.in.
            </p>

            <p className='detail'>
              These Legal Terms constitute a legally binding agreement made
              between you, whether personally or on behalf of an entity (
              <span className='highlight'>"you"</span>), and MTS Travel Tech Pvt
            ...
            <p className='detail'>
              ...
              change. Its your responsibility to periodically review these Legal
        ...
        <h2 className='detail'>TABLE OF CONTENTS</h2>
        <ol className='detail' style={{ padding: '0 20px' }}>
          <li className='detail'>
            <a className='go-to-id' href='#our-services'>
              OUR SERVICES.
            </a>
          </li>
          <li className='detail'>
            <a className='go-to-id' href='#property-rights'>
              INTELLECTUAL PROPERTY RIGHTS
            </a>
          </li>
          <li className='detail'>
            <a className='go-to-id' href='#user-representations'>
              USER REPRESENTATIONS
            </a>
          </li>
          <li className='detail'>
            <a className='go-to-id' href='#prohibited-activities'>
              PROHIBITED ACTIVITIES.
            </a>
          </li>
          <li className='detail'>
            <a className='go-to-id' href='#user-contributions'>
              USER GENERATED CONTRIBUTIONS
            </a>
          </li>
          <li className='detail'>
            <a className='go-to-id' href='#contribution-license'>
              CONTRIBUTION LICENSE
            </a>
          </li>
          <li className='detail'>
            <a className='go-to-id' href='#services-management'>
              SERVICES MANAGEMENT
            </a>
          </li>
          <li className='detail'>
            <a className='go-to-id' href='#term-and-termination'>
              TERM AND TERMINATION
            </a>
          </li>
          <li className='detail'>
            <a className='go-to-id' href='#modifications-and-interruptions'>
              MODIFICATIONS AND INTERRUPTIONS
            </a>
          </li>
          <li className='detail'>
            <a className='go-to-id' href='#governing-law'>
              GOVERNING LAW
            </a>
          </li>
          <li className='detail'>
            <a className='go-to-id' href='#dispute-resolution'>
              DISPUTE RESOLUTION
            </a>
          </li>
          <li className='detail'>
            <a className='go-to-id' href='#corrections'>
              CORRECTIONS
            </a>
          </li>
          <li className='detail'>
            <a className='go-to-id' href='#disclaimer'>
              DISCLAIMER
            </a>
          </li>
          <li className='detail'>
            <a className='go-to-id' href='#limitations-of-liability'>
              LIMITATIONS OF LIABILITY
            </a>
          </li>
          <li className='detail'>
            <a className='go-to-id' href='#indemnification'>
              INDEMNIFICATION
            </a>
          </li>
          <li className='detail'>
            <a className='go-to-id' href='#user-data'>
              USER DATA
            </a>
          </li>
          <li className='detail'>
            <a className='go-to-id' href='#communications'>
              ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES
            </a>
          </li>
          <li className='detail'>
            <a className='go-to-id' href='#miscellaneous'>
              MISCELLANEOUS
            </a>
          </li>
          <li className='detail'>
        ...
        <ol className='detail' style={{ padding: '20px' }}>
          <>
            <h1 id='our-services'>
              <li className='detail'>OUR SERVICES.</li>
            </h1>
            <>
              <p className='detail'>
          ...
          <>
            <h1 id='property-rights'>
              <li className='detail'>INTELLECTUAL PROPERTY RIGHTS</li>
            </h1>
            <>
              <p className='detail'>
                <span className='highlight'>Our intellectual property</span>
              </p>
              <p className='detail'>
              ...
              <p className='detail'>
                ...
                competition laws) and treaties in the India and around the
                world.
              </p>

              <p className='detail'>
                <span className='highlight'>Your use of our Services</span>
              </p>
              ...
              <p className='detail'>
                solely for your personal, non-commercial use or intemal business
                purpose.
              </p>
              ...
              <p className='detail'>
                ...
                Terms, please address your request to info@tripsaverz.in If we
              ...
              <p className='detail'>
                ...
                Services wil terminate immediately.
              </p>

              <p className='detail'>
                <span className='highlight'>Your submissions</span>
              </p>
              ...
              <p className='detail'>
                <span className='highlight'>Submissions:</span> By directly
              ...
              <p className='detail'>
                ...
                may suffer because of your breach of (a) tis section, (b) any
          ...
          <>
            <h1 id='user-representations'>
              <li className='detail'>USER REPRESENTATIONS</li>
            </h1>
            <>
              <p className='detail'>
              ...
              <p className='detail'>
                ...
                current, of incomplete, we have the right to suspend or
          ...
          <>
            <h1 id='prohibited-activities'>
              <li className='detail'>PROHIBITED ACTIVITIES.</li>
            </h1>
            <>
              <p className='detail'>
              ...
              <p className='detail'>
                ...
                >
                  ...
                  <li>
                    ...
                    posting of repetitive tex), that interferes with any party's
                  ...
                  <li>
                    ...
                    spider, robot, cheat utiity, scraper, or offine reader that
          ...
          <>
            <h1 id='user-contributions'>
              <li className='detail'>USER GENERATED CONTRIBUTIONS</li>
            </h1>
            <>
              <p className='detail'>
          ...
          <>
            <h1 id='contribution-license'>
              <li className='detail'>CONTRIBUTION LICENSE</li>
            </h1>
            <>
              <p className='detail'>
          ...
          <>
            <h1 id='services-management'>
              <li className='detail'>SERVICES MANAGEMENT</li>
            </h1>
            <>
              <p className='detail'>
                ...
                and without limitation, notice, or liabilty, to remove from the
                ...
                and () otherwise manage the Services in a manner designed to
          ...
          <>
            <h1 id='term-and-termination'>
              <li className='detail'>TERM AND TERMINATION</li>
            </h1>
            <>
              <p className='detail'>
              ...
              <p className='detail'>
                ...
                without imitation pursuing civil, criminal, and injunctive
                redress.
              </p>
            </>
          </>
          ...
          <>
            <h1 id='modifications-and-interruptions'>
              <li className='detail'>MODIFICATIONS AND INTERRUPTIONS</li>
            </h1>
            <>
              <p className='detail'>
              ...
              <p className='detail'>
                ...
                to perform maintenance related to the Services, resuling in
                ...
                any corrections, updates, of releases in connection therewith.
              </p>
            </>
          </>
          ...
          <>
            <h1 id='governing-law'>
              <li className='detail'>GOVERNING LAW</li>
            </h1>
            <>
              <p className='detail'>
                These Legal Terms shall be governed by and defined following the
                laws of . and yourself irrevocably consent that the courts of
          ...
          <>
            <h1 id='dispute-resolution'>
              <li className='detail'>DISPUTE RESOLUTION</li>
            </h1>
            <>
              <p className='detail'>
                <span className='highlight'>Informal Negotiations</span>
              </p>
              <p className='detail'>
              ...
              <p className='detail'>
                <span className='highlight'>Binding Arbitration</span>
              </p>
              <p className='detail'>
                In the event that mediation fails, any controversy or claim
                arising out of or relating to this Agreement or breach of any
                duties hereunder shall be settled by Arbitration in accordance
                with the Arbitration and Conciliation Act of India, 1996. All
                hearings will be held in NEW DELHI India and shall be conducted
                in English. The parties shall each appoint an arbitrator who
                shall then appoint a sole arbitrator to preside over the
          ...
          <>
            <h1 id='corrections'>
              <li className='detail'>CORRECTIONS</li>
            </h1>
            <>
              <p className='detail'>
                There may be information on the Services that contains
                typographical errors, inaccuracies, or omissions, including
                descriptions, pricing, availabilty, and various other
          ...
          <>
            <h1 id='disclaimer'>
              <li className='detail'>DISCLAIMER</li>
            </h1>
            <>
              <p className='detail'>
                ...
                OTHER ADVERTISING, AND WE WILL NOT BEA PARTY TO OR IN ANY WAY BE
          ...
          <>
            <h1 id='limitations-of-liability'>
              <li className='detail'>LIMITATIONS OF LIABILITY</li>
            </h1>
            <>
              <p className='detail'>
          ...
          <>
            <h1 id='indemnification'>
              <li className='detail'>INDEMNIFICATION</li>
            </h1>
            <>
              <p className='detail'>
                ...
                attomeys' fees and expenses, made by any third party due to or
                ...
                via the Services. Not withstanding the foregoing, we reserve the
          ...
          <>
            <h1 id='user-data'>
              <li className='detail'>USER DATA</li>
            </h1>
            <>
              <p className='detail'>
                ...
                responsible for al data that you transmit or that relates to any
          ...
          <>
            <h1 id='miscellaneous'>
              <li className='detail'>MISCELLANEOUS</li>
            </h1>
            <>
              <p className='detail'>
                ...
                drafted them. You hereby waive any and al defenses you may have
          ...
          <>
            <h1 id='contact-us'>
              <li className='detail'>CONTACT US</li>
            </h1>
            <>
              <p className='detail'>
                ...
                <span className='highlight'> info@tripsaverz.in</span>
              </p>
            </>
          </>
        </ol>
